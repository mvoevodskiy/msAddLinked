 ...
 * Update an Item
 */
class msAddLinkedItemUpdateProcessor extends modObjectUpdateProcessor {
	...
	public function beforeSet() {
		...
		if (empty($id)) {
			return $this->modx->lexicon('msaddlinked_item_err_ns');
		}
...
return 'msAddLinkedItemUpdateProcessor';
