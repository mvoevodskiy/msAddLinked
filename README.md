...
`git clone http://github.com/splittingred/msAddLinked.git ./`

Then, create the target directory where you want to create the file.

Then, navigate to the directory msAddLinked is now in, and do this:
...
Now, you'll want to change references to msAddLinked in the files in your
new copied-from-msAddLinked repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'msAddLinked' to whatever the
name of your component is.

## Copyright Information

msAddLinked is distributed as GPL (as MODx Revolution is), but the copyright owner
(Shaun McCormick) grants all users of msAddLinked the ability to modify, distribute
and use msAddLinked in MODx development as they see fit, as long as attribution
